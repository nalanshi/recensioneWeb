 ...
 * Pagina dei contatti
 * 
 * Questa pagina carica il template HTML dei contatti e lo personalizza in base allo stato di login dell'utente.
 * 
...
$DOM = file_get_contents("../static/contatti.html");
